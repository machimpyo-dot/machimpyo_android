...
fun getMockContentInfo(contentUid: Int): ContentInfo {
    ...
    val titles = listOf("회사 그만둘때\n" +
            "이렇게 말하는거 괜찮을까?","미뤄왔던 여행,\n어디로 가면 좋을까?","이제는 떠나야할 때\n" +
            "언제말하는게 가장 좋을까?")

    val subtitles = listOf("퇴사시기 눈치 게임 시작? NO! 현명한 시기 내가 알려줄게","2023 한국 관광공사가 선정한 국내 살아보기 13선 소개!", "퇴사시기 눈치 게임 시작? NO! 현명한 시기 내가 알려줄게")

    val questions = listOf("회사그만둘때 \n" +
            "상사한테 말하는게 어려워 고민입니다.\n" +
            "사정이 있긴한데 솔직하게 말하는게 최선일지\n" +
            "고민입니다.","그동안 바빠서 여행을 못갔어요.\n오랫동안 여행을 가지 못했더니 이제는\n어디로 가야할지도 잘 모르겠/=*어요.\n도움을 받을 수 있을까요?","퇴사하기로 결정했습니다. 하지만 소심한 성격 탓에 말하기가 너무어렵네요 언제 말하는게 시기상 가장 좋을까요?선배와커피마실때? 일주일 전?")

    val referenceUrls = listOf("https://www.youtube.com/watch?v=xfqIwluXKYA&t=2s","https://korean.visitkorea.or.kr/travelmonth/trend/trend-d.do", "https://www.youtube.com/watch?v=f2PESfniVVA")

    val photoIds = listOf(R.drawable.content_detail0, R.drawable.content_detail1, R.drawable.content_detail2,)
